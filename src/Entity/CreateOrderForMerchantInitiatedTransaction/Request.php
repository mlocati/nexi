...
namespace MLocati\Nexi\Entity\CreateOrderForMerchantInitiatedTransaction;
...
class Request extends Entity
{
    ...
    /**
     * @see \MLocati\Nexi\Entity\CreateOrderForMerchantInitiatedTransaction\Request::getOrder()
     */
